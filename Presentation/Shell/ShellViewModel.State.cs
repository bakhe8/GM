...
namespace GuaranteeManager
{
    public sealed partial class ShellViewModel
    {
        ...
        private string _expiredMeta = $"إجمالي المبلغ {ArabicAmountFormatter.FormatSaudiRiyals(0)}";
        private string _expiredFollowUpCount = "0";
        private string _expiredFollowUpMeta = $"إجمالي المبلغ {ArabicAmountFormatter.FormatSaudiRiyals(0)}";
        private string _expiringSoonCount = "0";
        private string _expiringSoonMeta = $"إجمالي المبلغ {ArabicAmountFormatter.FormatSaudiRiyals(0)}";
        private string _activeCount = "0";
        private string _activeMeta = $"إجمالي المبلغ {ArabicAmountFormatter.FormatSaudiRiyals(0)}";
