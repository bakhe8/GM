...
namespace GuaranteeManager
{
    public sealed partial class ShellViewModel
    {
        ...
        private string _pendingRequestMeta = "إجمالي المبلغ 0 ريال";
        private string _expiredCount = "0";
        private string _expiredMeta = "إجمالي المبلغ 0 ريال";
        private string _expiredFollowUpCount = "0";
        private string _expiredFollowUpMeta = "إجمالي المبلغ 0 ريال";
        private string _expiringSoonCount = "0";
        private string _expiringSoonMeta = "إجمالي المبلغ 0 ريال";
        private string _activeCount = "0";
        private string _activeMeta = "إجمالي المبلغ 0 ريال";
