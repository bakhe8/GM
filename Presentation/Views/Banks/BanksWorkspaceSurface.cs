...
namespace GuaranteeManager
{
    public sealed class BanksWorkspaceSurface : UserControl
    {
        ...
        private System.Windows.Controls.Primitives.UniformGrid BuildMetrics()
        {
            ...
            metrics.Children.Add(WorkspaceSurfaceChrome.MetricCard("إجمالي المبلغ", _amountValue, "#E09408"));
        ...
        private static Grid CreateTableGrid()
        {
            ...
            grid.ColumnDefinitions.Add(new ColumnDefinition { Width = new GridLength(2.65, GridUnitType.Star) });
            return grid;
        }
