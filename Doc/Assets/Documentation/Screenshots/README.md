...
- `MediaState` تعطي snapshot مستقلة لمزودي الوسائط أنفسهم:
  ...
  - `AudioScopePolicy` التي تلخص:
    - source policy المقبولة للصوت
    - وهل نسمح system-mix fallback أم لا
    - ولماذا hearing evidence غير متاحة أو غير موثوقة بعد
...
- `AudioOn` لا تحاول “التسجيل رغم الغموض”:
  - إذا لم يوجد مزود يحقق سياسة `per-app-attested audio`
