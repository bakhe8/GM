...
- **Phase 5**: مكتملة
  ...
  - كما ثبتت adaptive roadmap الآن مبدأ مهم قبل أي مزود صوت فعلي:
    - إذا كان الهدف هو ملاحظة runtime faults التي كانت تُفهم قديمًا عبر "صوت خطأ"
    - فالأولوية الحالية هي `FaultWatch` و`runtime.fault`
    - لا `system-mix audio`
...
4. خطر كسر مسار قائم أثناء إصلاح مسار جديد
