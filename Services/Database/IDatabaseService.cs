...
namespace GuaranteeManager.Services
{
    public interface IDatabaseService
    {
        ...
        decimal SumGuaranteeAmounts(GuaranteeQueryOptions? options = null);
        List<BankPortfolioSummary> GetBankPortfolioSummaries();
        ...
        List<int> GetPendingWorkflowRequestRootIds();
        WorkflowRequest? GetWorkflowRequestById(int requestId);
        List<WorkflowRequest> GetWorkflowRequestsByRootId(int rootId);
        Dictionary<int, List<WorkflowRequest>> GetWorkflowRequestsByRootIds(IReadOnlyCollection<int> rootIds);
