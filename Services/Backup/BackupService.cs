...
namespace GuaranteeManager.Services
{
    public class BackupService
    {
        ...
        public Exception? LastAutoBackupError { get; private set; }
        ...
        public void PerformAutoBackup()
        {
            ...
            {
                LastAutoBackupError = ex;
                SimpleLogger.LogError(ex, "Automatic Backup");
                throw new InvalidOperationException(
                    "فشلت النسخة الاحتياطية التلقائية. راجع حالة التخزين والصلاحيات قبل الاعتماد على حماية النسخ الاحتياطية.",
                    ex);
            }
        }
