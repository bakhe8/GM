            ...
            string? responseAttachmentSourcePath = null)
        {
            ...
            using (SqliteTransaction transaction = connection.BeginTransaction())
            {
                try
                {
                    ...
                    foreach (WorkflowRequestAttachmentData replacementAttachment in context.Request.ReplacementAttachments)
                    {
                        if (string.IsNullOrWhiteSpace(replacementAttachment.SavedFileName))
                        {
                            continue;
                        }
                        ...
                        WorkflowExecutionDataAccess.InsertAttachmentRecord(
                            newGuaranteeId,
                            replacementAttachment.OriginalFileName,
                            replacementAttachment.SavedFileName,
                            replacementAttachment.FileExtension,
                            executedAt,
                            connection,
                            transaction,
                            replacementAttachment.DocumentType);
                    }
