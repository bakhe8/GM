    ...
    public static class AppMessageBox
    {
        ...
        public static MessageBoxResult Show(string message, string title, MessageBoxButton buttons, MessageBoxImage image)
        {
            ...
            return dialogs != null
                ...
                : global::GuaranteeManager.RtlMessageDialog.ShowDialogMessage(message, title, buttons, image);
        }
        ...
        public static void ShowInformation(string message, string title)
        {
            ...
            global::GuaranteeManager.RtlMessageDialog.ShowDialogMessage(message, title, MessageBoxButton.OK, MessageBoxImage.Information);
        }
        ...
        public static void ShowWarning(string message, string title)
        {
            ...
            global::GuaranteeManager.RtlMessageDialog.ShowDialogMessage(message, title, MessageBoxButton.OK, MessageBoxImage.Warning);
        }
        ...
        public static void ShowError(string message, string title)
        {
            ...
            global::GuaranteeManager.RtlMessageDialog.ShowDialogMessage(message, title, MessageBoxButton.OK, MessageBoxImage.Error);
        }
        ...
        public static bool Confirm(string message, string title)
        {
            ...
            return global::GuaranteeManager.RtlMessageDialog.ShowDialogMessage(message, title, MessageBoxButton.YesNo, MessageBoxImage.Question) == MessageBoxResult.Yes;
        }
